...
has better classification performance, especially for faces. But better performance usually comes with the trade-off of speed, from ~25 fps for YOLO down to ~10 fps for YOLO + FaceNet. 
<br/><br/>
